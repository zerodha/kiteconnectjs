...
/**
 * @classdesc API client class. In production, you may initialise a single instance of this class per <tt>api_key</tt>.
 * @constructor
 * @name KiteConnect
 *
 ...
 *	exchange for the <b><tt>request_token</tt></b>. Pre-login, this will default to null,
...
var KiteConnect = function(api_key, options) {
	...
	/**
	* Set the <b><tt>access_token</b></tt> received after a successful authentication.
	...
	*/
	...
	/**
	 * Set a callback hook for session (<b><tt>TokenError</b></tt> -- timeout, expiry etc.) errors.
	 * An <b><tt>access_token</b></tt> (login session) can become invalid for a number of
	...
	/**
	 * Do the token exchange with the <b><tt>request_token</b></tt> obtained after the login flow,
	 * and retrieve the <b><tt>access_token</b></tt> required for all subsequent requests. The
	 * response contains not just the <b><tt>access_token</b></tt>, but metadata for
	 ...
	 * @memberOf KiteConnect
	 * @instance
	 * @param {string} [access_token] Token to invalidate. Default is the active <b><tt>access_token</b></tt>.
	 */
	 ...
	 * If no <b><tt>order_id</b></tt> is specified, all orders for the day are returned.
	 */
	 ...
	 * If no <b><tt>order_id</b></tt> is specified, all trades for the day are returned.
	 */
	 ...
	 * If no <b><tt>segment</b></tt> is specified, all instruemnts are returned.
	 */
