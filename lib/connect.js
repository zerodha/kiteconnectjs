 ...
 *
 * kc.getAccessToken("request_token", "api_secret")
...
var KiteConnect = function(params) {
	...
	*/
	 ...
	 */
	self.getAccessToken = function(request_token, api_secret) {
	 ...
	 * @instance
	 *
	 * @param {string} access_token Token obtained from previous successful login.
	 * @param {string} api_secret API secret issued with the API key.
	 */
	self.renewAccessToken = function(access_token, api_secret) {
		var checksum = sha256(self.api_key + access_token + api_secret).toString();
