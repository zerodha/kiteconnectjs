...
regular).
    ...
    function _get(route, params, responseType, responseTransformer, postJson = false) {
        return request(route, "GET", params || {}, responseType, responseTransformer, postJson);
    }

    function _post(route, params, responseType, responseTransformer, postJson = false) {
        return request(route, "POST", params || {}, responseType, responseTransformer, postJson);
    }

    function _put(route, params, responseType, responseTransformer, postJson = false) {
        return request(route, "PUT", params || {}, responseType, responseTransformer, postJson);
    }

    function _delete(route, params, responseType, responseTransformer, postJson = false) {
        return request(route, "DELETE", params || {}, responseType, responseTransformer, postJson);
    }

    function request(route, method, params, responseType, responseTransformer, postJson) {
        // Check access token
