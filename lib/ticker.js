 ...
 * ---------------
 *
 * 	var KiteTicker = require("KiteTicker");
 * 	var ticker = new KiteTicker(api_key, user_id, access_token);
 *
 * 	ticker.connect();
...
var KiteTicker = function(api_key, user_id, public_token, address) {
	...
	// subscribe to an array of tokens.
	...
	// unsubscribe from an array of tokens.
	...
	// set tokens to a particular mode.
	...
	// on close/error of websocket, trigger the disconnect
	// event and start attemping reconnections
