...
export type MFInstrument = {
  ...
  plan: string;
  /**
   * Settlement export type of the fund (`T1`, `T2` etc.)
   */
...
export type MFSIP = {
  ...
  fund: string;
  /**
   * Dividend export type (growth, payout)
   */
  dividend_type: string;
  /**
   * BUY or SELL
...
export type Order = {
  ...
  transaction_type: string;
  /**
   * Order export type (MARKET, LIMIT etc.)
   */
  order_type: string;
  /**
...
export type GTTParams = {
  ...
  orders: {
    /**
     * Transaction export type (BUY or SELL).
     */
    transaction_type: TransactionType;
    /**
     * Order quantity
    ...
    product: Product;
    /**
     * Order export type (LIMIT, SL, SL-M, MARKET).
     */
    order_type: OrderType;
    /**
     * Order price.
...
export type Connect = {
  ...
  convertPosition: (params: {
    ...
    transaction_type: TransactionType;
    /**
     * Position export type (overnight, day).
     */
   ...
   * @param transaction_type Transaction export type (BUY or SELL).
   */
  getTriggerRange: (
    exchange: Exchange,
    tradingsymbol: string,
  ...
  modifyOrder: (
    ...
    params: {
      ...
      price?: number;
      /**
       * Order export type (NRML, SL, SL-M, MARKET).
       */
      order_type?: OrderType;
      /**
